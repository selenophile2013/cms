...
<div class="row">
	<?php $no=1; foreach ($fasilitas as $aa) {?>
	<div class="col-lg-4">
		<article>
			<div class="post-img">
				<img src="<?=  base_url('assets/upload/fasilitas/'.$aa['foto'])?>" alt="" class="img-fluid">
				<div class="card-body">
					<h5 class="card-title"> <?= $aa['judul'] ?></h5>
					<a href="<?= base_url('admin/fasilitas/delete_data/'.$aa['foto']);?>" class="btn btn-primary"
						onClick="return confirm('Apakah anda yakin menghapus data ini🌝?')"><i class="ti-trash"></i></a>
					<button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#fasilitas<?= $no?>">
					<span class="ti-pencil"></span>
					</button>
					<div class="modal fade" id="fasilitas<?= $no; ?>" tabindex="-1" aria-hidden="true">
						<div class="modal-dialog modal-md" role="document">
							<form action="<?= base_url('admin/fasilitas/update')?>" method="post"
