<html lang="en"><head>
        ...
        <link rel="stylesheet" href="<?= base_url('assets/life')?>/lib/animate/animate.min.css">
        <link href="<?= base_url('assets/life')?>/lib/lightbox/css/lightbox.min.css" rel="stylesheet">
        <link href="<?= base_url('assets/life')?>/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
    ...
    <body>
        ...
        <!-- Navbar & Hero Start -->
        <div class="container-fluid nav-bar px-0 px-lg-4 py-lg-0" style="top: -100px;">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light"> 
                    ...
                    <div class="d-none d-xl-flex flex-shrink-0 ps-4">
                        <a href="#" class="btn btn-light btn-lg-square rounded-circle position-relative wow tada" data-wow-delay=".9s" style="visibility: visible; animation-delay: 0.9s; animation-name: tada;">
        ...
        <div class="container-fluid bg-breadcrumb">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInDown;">Contact Us</h4>
        ...
        <!-- Footer Start -->
        <div class="container-fluid footer py-5 wow fadeIn" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-xl-9">
                        <div class="mb-5">
                        ...
                        <div class="footer-item">
                            ...
                            <div class="d-flex flex-shrink-0">
                                <div class="footer-btn">
                                    <a href="#" class="btn btn-lg-square rounded-circle position-relative wow tada" data-wow-delay=".9s" style="visibility: visible; animation-delay: 0.9s; animation-name: tada;">
                                        <i class="fa fa-phone-alt fa-2x"></i>
        ...
        <script src="<?= base_url('assets/life')?>/lib/wow/wow.min.js"></script>
        <script src="<?= base_url('assets/life')?>/lib/easing/easing.min.js"></script>
        <script src="<?= base_url('assets/life')?>/lib/waypoints/waypoints.min.js"></script>
        <script src="<?= base_url('assets/life')?>/lib/counterup/counterup.min.js"></script>
        <script src="<?= base_url('assets/life')?>/lib/lightbox/js/lightbox.min.js"></script>
        <script src="<?= base_url('assets/life')?>/lib/owlcarousel/owl.carousel.min.js"></script>
