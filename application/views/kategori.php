						...
						<div class="classy-menu" id="originalNav">
							...
							<div class="classynav">
								...
								<ul>
									...
									<li><a href="<?= base_url('home/range')?>">RANGE</a></li>
								</ul>
								<!-- Nav End -->
							</div>
						</div>
				...
				<div class="col-12 col-lg-4">
					<div class="single-blog-area clearfix mb-100">
						...
						<div class="single-blog-content">
							<div class="line"></div>
							<a href="#" class="post-tag">MATA TRANS Transport</a>
   				...
   				foreach ($end_konten as $uu) { ?>
					<div class="col-12 col-lg-6 mt-10">
						...
						<div class="single-blog-content">
							...
							<p class="mt-3">Artikel ini ditulis oleh <strong><?= $uu['nama']?></strong> dan merupakan
								bagian dari kategori <strong><?= $uu['nama_kategori']?></strong>. Temukan informasi
								menarik dan inspiratif seputar perjalanan bersama Mata Trans melalui artikel ini.
								Dapatkan pengalaman membaca yang menyenangkan dengan berbagai topik menarik yang telah
								disediakan.</p>
